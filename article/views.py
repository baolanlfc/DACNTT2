...
def addArticle(request):
    ...
    if form.is_valid():
        ...
        messages.success(request,"Bai viet duoc them thanh cong")
...
def deleteArticle(request,id):
    ...
    messages.success(request,"Xoa bai viet thanh cong")
...
def addComment(request,id):
    ...
    if request.method == "POST":
        comment_author = request.user #request.POST.get("comment_author")
