...
class Member(models.Model):
    ...
    rip_date = models.DateField(null = True)
    more_information = models.TextField(max_length = 500,null = True)
    family = models.ForeignKey("family.Family",on_delete = models.CASCADE,default=1)
    parent = models.ForeignKey("family.Member",on_delete = models.CASCADE,default=1)
    created_date = models.DateTimeField(auto_now_add=True)
